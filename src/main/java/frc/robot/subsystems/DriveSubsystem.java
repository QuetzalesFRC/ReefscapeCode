...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DriveSubsystem() {
    ...
    AutoBuilder.configure(
            ...
            this::getRelativeChassisSpeeds, // ChassisSpeeds supplier. MUST BE ROBOT RELATIVE
  ...
  public ChassisSpeeds getRelativeChassisSpeeds() {
    ...
    else return ChassisSpeeds.fromFieldRelativeSpeeds(speeds, Rotation2d.fromDegrees(getHeading()));
  }
  ...
  public void drive(ChassisSpeeds speeds) {
    this.speeds = speeds;
    SwerveModuleState[] m_moduleStates = Constants.DriveConstants.kDriveKinematics.toSwerveModuleStates(speeds);
