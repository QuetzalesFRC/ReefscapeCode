...
public final class Constants {
  ...
  /*
   * 
   * Los CAN IDs deben determinarse, los actuales son placeholders
   * 
   */
  ...
  public static final class ArmConstants {
    ...
    public static final double kArmUp = 0.25;
  ...
  public static final class RollerConstants {
    ...
    public static final double kArmRollerCoralOutFront = 0.3;
    public static final double kArmRollerAlgaeIn = 0.6;

    public static final double kArmRollerAlgaeOut = -0.4;
    public static final double kArmRollerCoralOutBack = 0.5;
  }

  public static final class ClimberConstants {
    public static final int kClimberCanId = 11;
    public static final double kArmClimberDown = 0.2;
